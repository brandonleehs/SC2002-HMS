...
/**
 * The ReceptionistRepository class manages the collection of receptionist
 * records. It provides methods for accessing, modifying, and serializing
 * receptionist data. The data is stored in a map with the receptionist's ID as
 * the key and the Receptionist object as the value.
 */
public class ReceptionistRepository implements IUserRepository<Receptionist> {
	...
	/**
	 * Constructor that initializes the ReceptionistRepository by deserializing
	 * receptionist data from a CSV file.
	 * 
	 * @param receptionistSerializer the serializer to deserialize the receptionist
	 *                               data
	 */
	 ...
	 * @return the receptionist associated with the specified ID, or {@code null} if
	 *         no receptionist exists with that ID
	 */
	@Override
	...
	/**
	 * Serializes the receptionist data and appends it to a CSV file. The data
	 * includes receptionist ID, name, role, gender, age, and password hash.
	 * 
	 */
	@Override
