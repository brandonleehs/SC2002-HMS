...
/**
 * This class represents a repository for managing {@link Doctor} objects.
 * It is responsible for serializing and deserializing doctor data to and from a CSV file.
 * It provides methods to retrieve, add, and remove doctors, as well as access their data in a map.
 */
public class DoctorRepository implements IUserRepository<Doctor> {
	...
	/**
     * Constructs a new {@code DoctorRepository}.
     * This constructor initializes the repository by deserializing doctor data 
     * from a file using the {@link DoctorSerializer}.
     */
     ...
     * @return the {@link Doctor} object with the given ID, or {@code null} if not found
     */
	@Override
	...
	/**
     * Deserializes the doctor data and writes it to a CSV file.
     * The file includes the doctor's ID, name, role, gender, age, password hash, and availability schedule.
     * 
